...
{
    name='fs_used_perc',           arg='/workspace/',                max_value=100,
    x=85,                          y=600,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/docker/',                max_value=100,
    x=85,                          y=700,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/jenkins/',                max_value=100,
    x=85,                          y=750,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/music/',                max_value=100,
    x=85,                          y=800,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/photo/',                max_value=100,
    x=85,                          y=850,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
